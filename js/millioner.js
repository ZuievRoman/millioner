...
function AppMillionerModel(){
    ...
    self.goToStep = function (n){
        self.currentStep(n);
        self.currentStepFormat(moneyCount-n+1);
    };
    ...
    function initCategories(){
        ...
        for (var i = 0;i<moneyCount;i++){
            ...
            categories.push({
                id: id,
                money: convertMoney(moneyArray[i]*n),
    ...
    function getCorrectAnswer(){
        return self.currentQuestion().correct;
    }
